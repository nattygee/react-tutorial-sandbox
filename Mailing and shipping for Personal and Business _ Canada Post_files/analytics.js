...
var isFPO = pathname.includes('/tools/find-a-post-office.page') || pathname.includes('/outils/trouver-un-bureau-de-poste.page');
...
if (hasAPL && !(isFPC || isFAR || isFPO)) {
  ...
  var label = isFPC ? 'fpc' : isFAR ? 'far' : isFPO ? 'fpo' : null;
  if (label) {
